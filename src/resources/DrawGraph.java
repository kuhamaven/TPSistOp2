...
public class DrawGraph extends JPanel {
    ...
    private static final int GRAPH_POINT_HEIGHT = 12;
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Point graphPoint : graphPoints) {
            ...
            g2.fillOval(x, y, GRAPH_POINT_WIDTH, GRAPH_POINT_HEIGHT);
        }
    }
    ...
    public static void showGui(List<Integer> scores) {
    ...
    private static void createAndShowGui() {
        ...
        for (int i = 0; i < maxDataPoints ; i++) {
            scores.add(random.nextInt(maxScore) + 1);
        }
        showGui(scores);
    }
